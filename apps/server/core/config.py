...
EMBEDDING_AUTO_GENERATE = os.getenv("TRIPPROOF_EMBEDDING_AUTO_GENERATE", "1").lower() in {
    "1",
    "true",
    "yes",
}
OLLAMA_BASE_URL = os.getenv("TRIPPROOF_OLLAMA_BASE_URL", "http://localhost:11434")
OLLAMA_EMBEDDING_TIMEOUT_SECONDS = float(os.getenv("TRIPPROOF_OLLAMA_EMBEDDING_TIMEOUT_SECONDS", "2.0"))
...
OLLAMA_FACT_TIMEOUT_SECONDS = float(os.getenv("TRIPPROOF_OLLAMA_FACT_TIMEOUT_SECONDS", "20.0"))
...
SUPABASE_INSERT_BATCH_SIZE = int(os.getenv("TRIPPROOF_SUPABASE_INSERT_BATCH_SIZE", "100"))
SUPABASE_REST_TIMEOUT_SECONDS = float(os.getenv("TRIPPROOF_SUPABASE_REST_TIMEOUT_SECONDS", "6.0"))
