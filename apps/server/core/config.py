...
OLLAMA_ANSWER_MODEL = os.getenv("TRIPPROOF_OLLAMA_ANSWER_MODEL", "qwen3:14b")
OLLAMA_ANSWER_TIMEOUT_SECONDS = float(
    os.getenv("TRIPPROOF_OLLAMA_ANSWER_TIMEOUT_SECONDS", "300.0")
)
...
OLLAMA_CAVEAT_TIMEOUT_SECONDS = float(
    os.getenv(
        "TRIPPROOF_OLLAMA_CAVEAT_TIMEOUT_SECONDS", str(OLLAMA_ANSWER_TIMEOUT_SECONDS)
    )
)
CAVEAT_EXTRACTOR_MODE = os.getenv("TRIPPROOF_CAVEAT_EXTRACTOR_MODE", "disabled").strip()
