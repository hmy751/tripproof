...
ANSWER_COMPOSER_BACKEND = os.getenv(
    "TRIPPROOF_ANSWER_COMPOSER_BACKEND", "ollama"
).lower()
OLLAMA_ANSWER_MODEL = os.getenv("TRIPPROOF_OLLAMA_ANSWER_MODEL", "gemma3:4b")
OLLAMA_ANSWER_TIMEOUT_SECONDS = float(
    os.getenv("TRIPPROOF_OLLAMA_ANSWER_TIMEOUT_SECONDS", "20.0")
)
