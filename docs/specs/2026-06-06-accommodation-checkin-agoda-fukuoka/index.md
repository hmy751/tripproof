...
이번 스펙은 사용자가 보유한 Agoda 예약 확정 PDF를 기준으로 한다.

제품 입력으로 먼저 다룰 파일은 Agoda 예약 확정 PDF 하나다.
...
- Gmail 계정에서 자동으로 가져오기, 원본 파일 보관 흐름은 이번 흐름에서 요구하지 않는다.
